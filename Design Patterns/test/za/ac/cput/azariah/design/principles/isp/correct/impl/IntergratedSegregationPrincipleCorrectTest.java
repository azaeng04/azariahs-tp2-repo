...
import za.ac.cput.azariah.design.principles.isp.correct.config.AppConfig;

/**
 *
 * @author Ronald
 */
public class IntergratedSegregationPrincipleCorrectTest {
    private static ApplicationContext ctx;
    private static CalculateShape circle;
    private static CalculateShape triangle;
    
    public IntergratedSegregationPrincipleCorrectTest() {
    }
